...
console.log('\nCopy ' + __spreadArray([], Place, true).sort());
//Show that your array is still in its orginal order printing it.
console.log('\nOriginal ' + Place);
//Print in your array in reverse alphabetical order without changing the order ofthe orginal list.
console.log('\nCopy ' + __spreadArray([], Place, true).sort().reverse());
...
console.log('\nOriginal ' + Place.sort());
// Sort to change your array so it's stored alphabetical order. Print the list to show that its order has changed.  
console.log('\nOriginal ' + Place.sort().reverse());
